...
abstract class BaseWordForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'wp_article' => new sfWidgetFormInputText(),
    ));

    $this->setValidators(array(
      'id'         => new sfValidatorDoctrineChoice(array('model' => $this->getModelName(), 'column' => 'id', 'required' => false)),
      'name'       => new sfValidatorString(array('max_length' => 160, 'required' => false)),
      'wp_article' => new sfValidatorString(array('max_length' => 160, 'required' => false)),
    ));
